...
namespace Backend.Controllers
{
    ...
    public class StoreController : Controller
    {
        ...
        [Route("get_all")]
        /**
         * Proporciona por medio del API la lista de tiendas
         * 
         */
        public object Get()
        {
        ...
        [Route("get/{id}")]
        /**
         * Proporciona por medio del API la tienda relacionada al id
         */
        ...
        [Route("add")]
        /**
         * Actualiza por medio del API una tienda a la base
         * Recibe un objeto storeinfo por medio del un JSON
         */
        ...
        [Route("delete/{id}")]
        /**
         * Elimina una tienda que tenga el id dado
         */
